...
export async function resetIndexedMatrixData() {
    ...
    const [positions, cycles, income, recycles, slots, users, events, idxUsers, idxReferrals, idxClub, idxPilot, idxTx, idxIncome, idxRewards, idxWithdrawals, idxSpins, idxStakes,] = await prisma.$transaction([
