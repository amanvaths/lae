...
import { getClubPackageAmount, getPilotPackageAmount, CLUB_PACKAGES, PILOT_PACKAGES, } from "../../config/packages.js";
export async function transactionRoutes(app) {
    ...
    app.post("/purchase", {
        ...
        const expectedAmount = body.matrixType === "CLUB"
            ? getClubPackageAmount(body.packageLevel)
            : getPilotPackageAmount(body.packageLevel);
        await processBlockchainDeposit(userId, body.txHash, expectedAmount, body.packageLevel, body.matrixType);
