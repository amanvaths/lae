...
export async function handleClubAutoUpgrade(tx, userId, currentLevel, withdrawAmount, idempotencyBase) {
 ...
 */
export async function handlePilotAutoUpgrade(tx, userId, packageLevel, cyclesCompleted, idempotencyBase, sponsorId) {
...
export async function handlePilotManualUpgrade(tx, userId, sponsorId, packageLevel, referenceId) {
...
//# sourceMappingURL=auto-upgrade.engine.js.map