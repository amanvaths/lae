...
export const LAE_MATRIX_EVENTS = [
  ...
  "event RecycleMatrixPlace(uint256 indexed user, uint256 indexed matrixOwner, uint8 level, uint256 cycle, uint8 spot)",
  "event SubMatrixPlace(uint256 indexed user, uint256 indexed matrixOwner, uint8 matrixType, uint8 level, uint256 cycle, uint8 spot)",
  ...
  "event PaymentTrace(uint256 indexed matrixId, uint8 matrixType, uint8 level, uint256 cycle, uint8 slot, uint256 boardOwnerId, uint256 fromUserId, uint256 receiverId, uint256 amount, bool holdApplied, bool upgradeOpened, bool recycledBoard)",
