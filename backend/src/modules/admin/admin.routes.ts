...
export async function womRoutes(app: FastifyInstance): Promise<void> {
  app.post("/submit", {
    preHandler: [app.authenticate],
...
export async function adminRoutes(app: FastifyInstance): Promise<void> {
  ...
  app.get("/config", {
    ...
    const { getSponsorPaymentConfig, getTokenRewardConfig, getPilotIncentiveConfig } =
      await import("../../services/admin-config.service.js");
