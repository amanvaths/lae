...
const MATRIX = process.env.LAE_MATRIX_CONTRACT_ADDRESS ?? "0x7258288fb13C1e35c9694DD9FC8803D5083315aE";
...
const FE_MATRIX = process.env.NEXT_PUBLIC_LAE_MATRIX_CONTRACT ?? "0x7258288fb13C1e35c9694DD9FC8803D5083315aE";
