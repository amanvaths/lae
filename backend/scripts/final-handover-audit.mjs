...
const MATRIX = process.env.LAE_MATRIX_CONTRACT_ADDRESS ?? "0x88B8bd1E8Ce3D5F178BA3E6CcCb8Ce8Aec230d48";
...
const FE_MATRIX = process.env.NEXT_PUBLIC_LAE_MATRIX_CONTRACT ?? "0x88B8bd1E8Ce3D5F178BA3E6CcCb8Ce8Aec230d48";
