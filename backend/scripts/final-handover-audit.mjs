...
const MATRIX = process.env.LAE_MATRIX_CONTRACT_ADDRESS ?? "0xF724Ea7Fc7436EAe6c504592b9FFbEdf4B0d236c";
...
const FE_MATRIX = process.env.NEXT_PUBLIC_LAE_MATRIX_CONTRACT ?? "0xF724Ea7Fc7436EAe6c504592b9FFbEdf4B0d236c";
