...
const MATRIX = process.env.LAE_MATRIX_CONTRACT_ADDRESS ?? "0xB65745665aFce75a7d8B804bda96B68a82adbC0D";
...
const FE_MATRIX = process.env.NEXT_PUBLIC_LAE_MATRIX_CONTRACT ?? "0xB65745665aFce75a7d8B804bda96B68a82adbC0D";
